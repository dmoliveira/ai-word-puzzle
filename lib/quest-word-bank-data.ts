...
export type CuratedEnglishLexicon = {
...
export function createCuratedLexiconWords(lexicon: CuratedEnglishLexicon, startIndex: number): PuzzleWord[] {
  const groups = [
    { band: "common" as const, words: lexicon.common },
    { band: "uncommon" as const, words: lexicon.uncommon },
    { band: "rare" as const, words: lexicon.rare },
  ];
...
const rawBaseWordBank: PuzzleWord[] = (() => {
  ...
  return [...themed, ...general, ...generated];
})();

function dedupeWordBank(entries: readonly PuzzleWord[]) {
...
export const wordBank: PuzzleWord[] = dedupeWordBank(rawBaseWordBank);

export function createQuestWordBank(lexicon: CuratedEnglishLexicon) {
  return dedupeWordBank([
    ...rawBaseWordBank,
    ...createCuratedLexiconWords(lexicon, rawBaseWordBank.length),
  ]);
}
